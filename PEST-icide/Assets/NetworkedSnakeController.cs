...
public class NetworkedSnakeController : NetworkBehaviour
{
    // Movement
    ...
    void Start()
    {
        ...
        snakeAnimator = gameObject.GetComponent<Animator>();
    ...
    void MovementAnim()
    {
        ...
        snakeAnimator.SetFloat("Movement_X", xVel);
        snakeAnimator.SetFloat("Movement_Y", yVel);
    }
